export default class Utility {
  ...
  static toPage(url, params) {
    try {
      const __history = this.getContent('__history__');// this.constItem.HistoryInfo);
  ...
  static $showDialog(Html, Title, okButton, onCancel) {
    this.$emit(this.constItem.Events.ShowModel.OnShowDialog,
      { Title: Title, Html: Html, okButton: okButton, onCancel: onCancel, isShowAction: true, Options: { IsHideCancel: true, IsHideOk: true } }
    );
  }
